...
class CommentController extends AbstractController
{
     ...
     */
    public function add(Request $request, ArticleRepository $articleRepository, UserRepository $userRepository, CommentRepository $commentRepository, EntityManagerInterface $entityManager): Response
    {
